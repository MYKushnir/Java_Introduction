...
// создание метода фильтрации ноутбуков по критериям
    public List<Laptop> filter(Set<Laptop> laptop) {
        ...
        System.out.println("Укажите желаемые параметры ноутбука." +
        ...
        System.out.println("Укажите обьем оперативной памяти в Гб\nВналичии : 4, 8, 16 ");
...
// создание метода фильтрации ноутбуков по выборочной критериям
    public Set<Laptop> newFilter(Set<Laptop> laptop) {
        ...
        System.out.println("Укажите номер или номера критериев фильрации," + 
        "\n1. Обьем жесткого диска\n2. Обьем оператвной памяти\n3. Операционная система\n4. Цвет");
...
// метод toString, выводит на экран данные объекта
    ...
    public String toString() {
        return "\nНоутбук  ->  " + model + "\nПроизводитель = " + brands + ",\nДиагональ экрана = " + diagonal + ",\nРазрешение экрана = "
                + screenResolution
                + ",\nDVD привод = " + dvdRom + ",\nОбьем жесткого диска = " + hardDisk + ",\nОбьем RAM = " + operativeMemory
